...
export default function SettingsClient({ departments }: Props) {
  ...
  // Map API departments to table rows
  const deptRows = departments.map((dept) => ({
    name: dept.department_name,
    monthlyLimit: formatKRW(dept.monthly_budget_limit),
    singleLimit: "-",
    usage: formatKRW(dept.current_spending),
